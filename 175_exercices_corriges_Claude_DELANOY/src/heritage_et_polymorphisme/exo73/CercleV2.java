...
public class CercleV2{
    private double rayon;
    private Point centre;

    public CercleV2(Point centre, double r) {
        this.centre = centre;
        rayon = r;
    }
    ...
    public void affiche(){
        System.out.println("Point de coordonnees " + this.centre.getX() + " " + this.centre.getY() + " et de rayon " + this.rayon);
    }
}
